...
function saindo(){
    ...
    localStorage.removeItem("Usarlogado");
    localStorage.removeItem("@usuariosestudo");

    window.location.href = "../teladelogin/indexlogin.html"
}

let listaUser = Number(sessionStorage.getItem('token'));
